...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // pd.show();
       // getCategoryFromDB();
        if(GeobuyConstants.categoryMasters != null && GeobuyConstants.categories != null)
            formUiforCategory();
        else
            getCategoryFromDB();
        return view;
    ...
    private void formUiforCategory() {
        categoryAdapter = new CategoryMasterAdapter(this.getContext(), GeobuyConstants.categoryMasters, GeobuyConstants.categories);
